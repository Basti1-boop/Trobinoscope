...
<head>
    ...
    <style>
        .admin-header {
            background: linear-gradient(135deg, var(--accent), #a83d22);
            color: white;
            padding: 2rem;
        ...
        .block-form input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(201, 75, 44, 0.1);
        }
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="admin.php" style="color: var(--accent); font-weight: 600;">Admin</a></li>
